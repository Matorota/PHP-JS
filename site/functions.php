...
?>
<form name="form1" method="post" action="" class="atsiliepimu">
    ...
    <p><textarea name="atsiliepimas" id="textarea" cols="25" rows="3">Atsiliepimas
	</textarea>*</p>
...
function rodyti(){
	...
	for($i = count($eil)-1; $i >= 0; $i--) {
		$e = explode("**", $eil[$i]);
		echo "<div class='atsiliepimas'><a href='mailto:".$e[1]."'>".$e[0]."</a> <span class='data'>[".$e[3]."]</span> <p class='pranesimas'>".$e[2]."</p></div>";
	}
}
